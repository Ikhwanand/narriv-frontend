    ...
    >
      <Globe2
        ...
        className={cn(
          ...
          language === "id" ? "rotate-0" : "rotate-180",
        )}
      />
      <span
        key={language}
  ...
  return (
    <div className="mx-auto mb-9 flex h-[136px] w-[136px] items-center justify-center rounded-full bg-[#F0EFFF] text-[#3626F6]">
      {variant === "shield" ? (
        ...
        <LockKeyhole size={70} strokeWidth={1.8} />
      )}
      {variant === "lock-check" ? (
        <span className="-ml-6 mt-12 flex h-10 w-10 items-center justify-center rounded-full bg-[#3626F6] text-white">
